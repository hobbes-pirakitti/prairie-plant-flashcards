            ...
            {               
                ...
                : currentFilter !== "" && getFilteredPlants(currentFilter).length === 0 ? (
                    <div id="all-done-group">
                        ...
                        <PlantGroupSelect totalPlants={plants.length} selectedValue={currentFilter} showBlank={true} onChange={handleDropdownFilterChange} groups={getPlantGroupsAndCounts()} />
                    </div>                    
                )
                : currentPlant === null ? (
                    <p>Loading...</p>
                ...
                : (
                    <div id="card-wrapper">
                        <div id="flex-wrapper">
                            ...
                            <PlantGroupSelect totalPlants={plants.length} selectedValue={currentFilter} showBlank={false} onChange={handleDropdownFilterChange} groups={getPlantGroupsAndCounts()} />
